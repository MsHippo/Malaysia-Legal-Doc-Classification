...
#Keywords file
# Keywords filepath
Section_keywords = pd.read_excel(r"C:\Users\heihe\OneDrive\Documents\final_year_project\fyp\coding\data\label.xlsx")
...
print(keyword_list)
test_data.to_excel("training.xlsx")
...
for i in range(0,len(test_data['TEXT'])):
    re.sub(r'[^\w]', ' ', test_data.iloc[i]['TEXT'])
...
#Main Training + Feedback data filepath
full_data.to_excel(os.path.join(""))  
print(full_data)

#Specify Main code filepath
os.system("python """) 
