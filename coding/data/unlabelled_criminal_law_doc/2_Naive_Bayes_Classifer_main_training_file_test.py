...
for file in files_list:
    ...
    for i in range(0 , pdfReader.numPages):
        ...
        #Extracting first 3 pages from PDF
        if i <=3:   
...
#Export to excel file (specify path) to create training data
pd.DataFrame(file_content).to_excel("corpus.xlsx")  


# In[56]:
files_list=[]
#filepath for retrained data (training data + feedback data).
...
#haven't complete
Section_keywords = pd.read_excel("C:\\Users\\heihe\\OneDrive\\Documents\\final_year_project\\fyp\\coding\\keywords_individual_words.xlsx")
...
# pd.DataFrame(keyword_list_unique).to_excel("C:\\Users\\heihe\\OneDrive\\Documents\\final_year_project\\fyp\\coding\\keywords_list.xlsx")
...
root_path = "C:\\Users\\heihe\\OneDrive\\Documents\\final_year_project\\fyp\\coding\\data\\trained_model"
...
filename = "C:\\Users\\heihe\\OneDrive\\Documents\\final_year_project\\fyp\\coding\\data" + "NB_Model_" + str(rand_num_model) + ".mdl"
#print(filename)
